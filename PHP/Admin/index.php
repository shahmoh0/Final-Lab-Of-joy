...
$totalRevenue   = $db->query('SELECT COALESCE(SUM(total_price),0) FROM orders')->fetchColumn();
...
<div class="adminPanel">
  ...
  <div class="statsRow">
    ...
    <div class="statCard">
      <div class="statNum"><?= number_format((float)$totalRevenue, 0) ?></div>
      <div class="statLabel">Revenue (SAR)</div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap;">
      ...
      <a href="orders.php"                class="btn btn-ghost">Manage Orders</a>
      <a href="users.php"                 class="btn btn-ghost">Manage Users</a>
    </div>
  </div>
